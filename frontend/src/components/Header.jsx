  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap  bg-blue-400 rounded-lg px-6 md:px-10 lg:px-20 '>
      ...
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 text-white text-sm font-light text-center md:text-left px-2">
  <img
    className="w-16 sm:w-20 md:w-28"
    src={assets.group_profiles}
    alt=""
  />
  <p className="max-w-xs sm:max-w-md md:max-w-lg">
